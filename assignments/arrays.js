...
let carModels = []; 
//For loop used to pull out all car models from the inventory array and push them into carModels array
...
let oldCars = [];
//first:go through carYears to identify all years <2000, maybe using filter()?
//second: .length for the number of cars
oldCars = carYears.filter (year => year < 2000).length;
console.log(oldCars); 

// ==== Challenge 6 ====
// A buyer is interested in seeing only BMW and Audi cars within the inventory.  Return an array that only contains BMW and Audi cars.  Once you have populated the BMWAndAudi array, use JSON.stringify() to show the results of the array in the console.
//first: go through inventory to seek BMW and Audi and push it into BMWAndAudi
//second: use Json.stringify to turn it into a string
let BMWAndAudi = [];
